export function SEOContent() {
  return (
    <div className="mb-8 bg-[#EDEDED] rounded-xl p-8 max-w-[1000px] mx-auto border border-black/15">
      ...
      <div className="text-gray-700 text-sm leading-relaxed space-y-4">
        <div>
          <h3 className="text-black font-bold mb-2">Jogos de Cassino Online</h3>
          <p>
        ...
        <div>
          <h3 className="text-black font-bold mb-2">Segurança e Licenciamento</h3>
          <p>
        ...
        <div>
          <h3 className="text-black font-bold mb-2">Métodos de Pagamento</h3>
          <p>
      ...
      <div className="mt-6 pt-6 border-t border-black/15">
        <div className="flex flex-wrap gap-2">
          {['Cassino Online', 'Slots', 'Cassino Ao Vivo', 'Aviator',
            'Fortune Tiger', 'Bônus', 'PIX', 'Crash Games', 'Roleta'].map((tag) => (
            <span
              key={tag}
              className="bg-black/5 text-gray-700 px-3 py-1 rounded-full text-xs border border-black/15 hover:border-[#58B0B1]/30 hover:text-[#58B0B1] transition-colors"
            >
              {tag}
            </span>
          ))}
